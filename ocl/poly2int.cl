...
void poly2int0_4_16(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(4, 16);
	poly2int0(L, X, 4, 16, x, cr, norm);
}

__kernel __attribute__((reqd_work_group_size(32, 1, 1)))
void poly2int0_4_32(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(4, 32);
	poly2int0(L, X, 4, 32, x, cr, norm);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void poly2int0_4_64(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(4, 64);
	poly2int0(L, X, 4, 64, x, cr, norm);
}
...
__kernel __attribute__((reqd_work_group_size(16, 1, 1)))
void poly2int0_8_16(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(8, 16);
	poly2int0(L, X, 8, 16, x, cr, norm);
}

__kernel __attribute__((reqd_work_group_size(32, 1, 1)))
void poly2int0_8_32(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(8, 32);
	poly2int0(L, X, 8, 32, x, cr, norm);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void poly2int0_8_64(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(8, 64);
	poly2int0(L, X, 8, 64, x, cr, norm);
}
...
void poly2int0_16_8(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(16, 8);
	poly2int0(L, X, 16, 8, x, cr, norm);
}

__kernel __attribute__((reqd_work_group_size(16, 1, 1)))
void poly2int0_16_16(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(16, 16);
	poly2int0(L, X, 16, 16, x, cr, norm);
}

__kernel __attribute__((reqd_work_group_size(32, 1, 1)))
void poly2int0_16_32(__global uint2 * restrict const x, __global long * restrict const cr, const uint2 norm)
{
	POLY2INT0_VAR(16, 32);
	poly2int0(L, X, 16, 32, x, cr, norm);
}
